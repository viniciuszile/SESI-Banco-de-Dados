...
SELECT * FROM ENDERECO_MEDIDCO_CONVS;
...
insert into ENDERECO_MEDIDCO_CONVS value(default,'04470389','Travessa São Sebastião',1005,'Parque Primavera','Casa A','lado do Banco','Sâo Paulo','SP','Basil','Residencial', NOW(), NOW(),'1');
...
insert into ENDERECO_MEDIDCO_CONVS value(default,'04467270','Rua Adauto Lemos',36,'Vila missionaria','Casa B','lado do MC','Rio de Janeiro','Rj','Basil','Comercial', NOW(), NOW(),'2');
